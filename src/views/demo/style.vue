<template>
  <div>
    ...
    <p class="one-line">
      Less全局方法：单行文本省略单行文本省略单行文本省略单行文本省略单行文本省略单行文本省略单行文本省略单行文本省略
    </p>
    <p class="more-line">
      Less全局方法：多行文本省略多行文本省略多行文本省略多行文本省略多行文本省略多行文本省略多行文本省略多行文本省略
    </p>
    ...
    <p class="tips">Vue2.7 样式穿透使用 ::v-deep(selector) :deep(selector) 选择器</p>
  </div>
</template>
